...
- [第2章 先把概念讲清楚：避免架构讨论中的认知混用](#chapter-02)
- [第3章 传统企业应用架构的结构性瓶颈](#chapter-03)
- [第4章 Agent-Native 设计原则：从“能接模型”到“能规模化运行”](#chapter-04)
- [第5章 目标参考架构总览：从应用分层到能力分层](#chapter-05)
- [第6章 Interface 层深挖：为什么 REST + Discovery 更适合 Agent 执行](#chapter-06)
- [第7章 Capability 层深挖：企业能力如何被 Agent 稳定编排](#chapter-07)
- [第8章 Data 与 Memory 层深挖：让 Agent 在企业上下文中持续正确](#chapter-08)
- [第9章 Runtime 层深挖：把 Agent 从“会回答”变成“能交付结果”](#chapter-09)
